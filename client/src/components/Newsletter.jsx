...
const Newsletter = () => {
  return (
    <div className='items-center justify-center text-center flex flex-col space-y-2 my-32'>
...
outline-none w-full rounded-r-none px-3 text-gray-5001 type="text' type="text" placeholder='Enter your email id' />
